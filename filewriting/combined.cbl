      ...
      * DATAFILE REFERS TO LOADED DATA
	   SELECT PRINTFILE ASSIGN TO "RESULTS.DAT".
      ...
      * BY DEFAULT
           ...
           PERFORM 0300-CLOSE-FILE.
      *    PERFORM 0400-WRITE-DATA.

       0110-WRITE-HEADERS.
           MOVE HEADERS TO PRINT-LINE.
           WRITE PRINT-LINE AFTER ADVANCING PAGE.
           MOVE SPACES TO PRINT-LINE.
		   WRITE PRINT-LINE.

       0120-WRITE-DETAILS.
           MOVE WS-DATA TO PRINT-LINE.
           WRITE PRINT-LINE AFTER ADVANCING PAGE.
           MOVE SPACES TO PRINT-LINE.
		   WRITE PRINT-LINE.
      ...
      *0400-WRITE-DATA.
      *    WRITE TEXTFILE FROM INPUTTED-DATA
      *    END-WRITE.
